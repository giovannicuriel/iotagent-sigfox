class CacheHandler {
  ...
  correlate_dojot_and_sigfox_device_id(dojot_device_id: string, sigfox_device_id: string) {
    this.dojot_to_sigfox[dojot_device_id] = sigfox_device_id;
    this.sigfox_to_dojot[sigfox_device_id] = dojot_device_id;
  ...
  get_dojot_device_id(sigfox_device_id: string): string {
